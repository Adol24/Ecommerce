...
const statusConfig: Record<string, { label: string; variant: "default" | "secondary" | "destructive" | "outline"; className: string }> = {
  ACTIVE: { label: "Activo", variant: "default", className: "bg-green-600" },
  INACTIVE: { label: "Inactivo", variant: "secondary", className: "" },
  SUSPENDED: { label: "Suspendido", variant: "destructive", className: "" },
}
